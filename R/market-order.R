...
post_kucoin_limit_order <- function(symbol, side, size , price,time_in_force,cancel_after) {
...
post_limit_order <- function(symbol, side, size , price ,time_in_force,cancel_after) {
