...
post_kucoin_limit_order <- function(symbol, side, size , price,timeInForce,cancelAfter,hidden) {
...
post_limit_order <- function(symbol, side, size , price ,timeInForce,cancelAfter,hidden) {
